...
@section('content')
    <div class="card card-docs flex-row-fluid mb-2">
        <div class="card-body fs-6 text-gray-700">
            <form action="{{ route('LatihanSoal.update', $latihanSoal->id) }}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="card-body p-9">
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            <textarea name="soal" id="soal" class="form-control" value="{{ $latihanSoal->soal }}" placeholder="Input Soal">
                                @if (old('soal'))
{{ old('soal') }}
@elseif(isset($latihanSoal))
{{ $latihanSoal->soal }}
@endif
                            </textarea>
                        </div>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            <textarea name="konten_bacaan_teks" id="konten_bacaan_teks" class="form-control"
                                value="{{ $latihanSoal->konten_bacaan_teks }}" placeholder="Input Konten Bacaan Teks">
                                @if (old('konten_bacaan_teks'))
{{ old('konten_bacaan_teks') }}
@elseif(isset($latihanSoal))
{{ $latihanSoal->konten_bacaan_teks }}
@endif
                            </textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            ...
                            <textarea name="jawaban_a" id="answer_a" class="form-control z-depth-1 mt-2" rows="3"
                                value="{{ $latihanSoal->jawaban_a }}" placeholder="Input Jawaban A">@if (old('jawaban_a'))
{{ old('jawaban_a') }}
@elseif(isset($latihanSoal))
{{ $latihanSoal->jawaban_a }}
@endif
                                </textarea>
                            <input
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            ...
                            <textarea name="jawaban_b" id="answer_b" class="form-control z-depth-1 mt-2" rows="3"
                                value="{{ $latihanSoal->jawaban_b }}" placeholder="Input Jawaban B">@if (old('jawaban_b'))
{{ old('jawaban_b') }}
@elseif(isset($latihanSoal))
{{ $latihanSoal->jawaban_b }}
@endif
                            </textarea>
                            <input
                                class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 h-15 mt-2"
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            ...
                            <textarea name="jawaban_c" id="answer_c" class="form-control z-depth-1 mt-2" rows="3"
                                value="{{ $latihanSoal->jawaban_c }}" placeholder="Input Jawaban C">@if (old('jawaban_c'))
{{ old('jawaban_c') }}
@elseif(isset($latihanSoal))
{{ $latihanSoal->jawaban_c }}
@endif </textarea>
                            <input
                                class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 h-15 mt-2"
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            ...
                            <textarea name="jawaban_d" id="answer_d" class="form-control z-depth-1 mt-2" rows="3"
                                value="{{ $latihanSoal->jawaban_d }}" placeholder="Input Jawaban D">@if (old('jawaban_d'))
{{ old('jawaban_d') }}
@elseif(isset($latihanSoal))
{{ $latihanSoal->jawaban_d }}
@endif </textarea>
                            <input
                                class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 h-15 mt-2"
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            ...
                            <textarea name="jawaban_e" id="answer_e" class="form-control z-depth-1 mt-2" rows="3"
                                value="{{ $latihanSoal->jawaban_e }}" placeholder="Input Jawaban E">@if (old('jawaban_e'))
{{ old('jawaban_e') }}
@elseif(isset($latihanSoal))
{{ $latihanSoal->jawaban_e }}
@endif </textarea>
                            <input
                                class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 h-15 mt-2"
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            <select name="kunci_jawaban" class="form-select @error('kunci_jawaban') is-invalid @enderror"
                                ...
                                <option value="A" {{ $latihanSoal->kunci_jawaban == 'A' ? 'selected' : '' }}>A
                                </option>
                                <option value="B" {{ $latihanSoal->kunci_jawaban == 'B' ? 'selected' : '' }}>B
                                </option>
                                <option value="C" {{ $latihanSoal->kunci_jawaban == 'C' ? 'selected' : '' }}>C
                                </option>
                                <option value="D" {{ $latihanSoal->kunci_jawaban == 'D' ? 'selected' : '' }}>D
                                </option>
                                <option value="E" {{ $latihanSoal->kunci_jawaban == 'E' ? 'selected' : '' }}>E
                                </option>
                            </select>
                            @error('kunci_jawaban')
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg">
                            <input type="number" name="point_soal" class="form-control"
                                value="{{ $latihanSoal->point_soal }}" placeholder="Input Point Soal" />
                            @error('point_soal')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <select name="kategori_id" id="kategori_id" class="form-select" data-control="select2">
                                @foreach ($kategoriSoals as $kategoriSoal)
                                    <option value="{{ $kategoriSoal->id }}"
                                        {{ $kategoriSoal->id == $latihanSoal->kategori_id ? 'selected' : '' }}>
                                        {{ $kategoriSoal->name }}
                                    </option>
                                @endforeach
                            </select>
