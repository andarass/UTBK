@extends('layouts.app')
@section('title', 'Tambah Paket Ujian Soal Saintek')
@section('page-title')
    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
        <h1 class="page-heading d-flex text-dark fw-bold flex-column justify-content-center my-0">
            Tambah Paket Ujian Soal Saintek
        </h1>
    </div>
@endsection
@push('styles')
...
@section('content')
    <div class="card card-docs flex-row-fluid mb-2">
        <div class="card-body fs-6 text-gray-700">
            <form action="{{ route('admin.paket-soal-ujian-saintek.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
