                                ...
                                <div class="card-body pt-0">
                                    <div class="card-header d-flex justify-content-between p-0">
                                        ...
                                        <div class="d-flex flex-stack">
                                            <a type="button" class="btn btn-primary ms-2" href="{{ route('admin.paket-soal-ujian-saintek.create') }}">
                                                Tambah Paket Soal
                                            </a>
                                        </div>
                                    </div>
...
@push('scripts')
    <script>
        var datatableSoshum = $('#paket_ujian_soshum').DataTable({
            ...
            stateSave: false,
            ajax: {
                url: 'PaketSoalUjian/getPaketUjianSoshum',
            },
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
                ...
                {
                    data: 'kategori_utbk_id',
                    name: 'kategori_utbk_id',
                    orderable: true,
                    searchable: true,
                    width: '50%'
                },
        ...
        datatableSoshum.on('click', '.delete-confirm-paket-ujian-soshum', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    e.preventDefault();
                    var id = $(this).data("id");
                    var route = "{{ route('admin.paket-soal-ujian-soshum.destroy', ':id') }}";
