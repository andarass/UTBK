<div class="d-flex justify-content-between">
    @if ($previousSoal && $previousSoal->kategori_latihan_soal_id === $currentSoal->kategori_latihan_soal_id)
        <a href="{{ route('user.soal-mulai', ['kategoriLatihanSoalId' => $currentSoal->kategori_latihan_soal_id, 'soalId' => $previousSoal->id]) }}"
    ...
    @if ($nextSoal)
        @php
            $nextQuestionUrl = route('user.soal-mulai', [
                'kategoriLatihanSoalId' => $currentSoal->kategori_latihan_soal_id,
                'soalId' => $nextSoal->id,
            ]);
