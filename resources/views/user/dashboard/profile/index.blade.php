...
@section('title', 'Data Diri Pengguna')

@section('content')
    <div class="card mt-8 mb-5 mb-xl-10">
        <div class="card-body pt-9 pb-0">
            ...
            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                ...
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5" href="{{ route('user.overview') }}">Overview</a>
                </li>
                <!--end::Nav item-->
                <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 active"
                        href="{{ route('ProfileUser.index') }}">Settings</a>
                </li>
                <!--end::Nav item-->
            </ul>
            <!--begin::Navs-->
    ...
    <div class="card mt-11">
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="text-2xl first-letter:fw-bold m-0">Data Diri Pengguna</h3>
            </div>
        </div>

        <div id="kt_account_settings_profile_details" class="collapse show">
            <form id="kt_account_profile_details_form" method="POST" enctype="multipart/form-data"
                action="{{ route('user.update.profile') }}" class="form">
                @csrf
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        <!--begin::Label-->
                        <label class="col-lg-4 col-form-label required fw-semibold fs-6">Nomer Telepon</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input readonly type="number" name="name"
                                class="form-control form-control-lg form-control-solid" placeholder="Nomer Telepon"
                                value="{{ auth()->user()->nomer_tlp }}" />
                        </div>
                        <!--end::Col-->
                    </div>
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 fv-row">
                                    <input readonly type="text" name="kota_lahir"
                                        class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                        placeholder="Tempat Lahir" value="{{ auth()->user()->kota_lahir }}" />
                                </div>
                                <!--end::Col-->
                                <!--begin::Col-->
                                <div class="col-lg-6 fv-row">
                                    <input readonly type="date" name="tanggal_lahir"
                    ...
                    <div class="row mb-6">
                        <!--begin::Label-->
                        <label class="col-lg-4 col-form-label required fw-semibold fs-6">Kelurahan</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input readonly type="text" name="name"
                                class="form-control form-control-lg form-control-solid" placeholder="Kelurahan"
                    ...
                    <div class="row mb-6">
                        <!--begin::Label-->
                        <label class="col-lg-4 col-form-label required fw-semibold fs-6">Universitas</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input readonly type="text" name="universitas"
                                class="form-control form-control-lg form-control-solid" placeholder="Prodi name"
                                value="{{ auth()->user()->universitas->name ?? '-' }}" />
                        </div>
                        <!--end::Col-->
                    </div>
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input readonly type="text" name="prodi"
                                class="form-control form-control-lg form-control-solid" placeholder="Prodi name"
                                value="{{ auth()->user()->prodi->name ?? '-' }}" />
                        </div>
                        <!--end::Col-->
                    </div>
                    <div class="row mb-6">
