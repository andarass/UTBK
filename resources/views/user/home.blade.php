          ...
          <div class="container">
              <nav class="navbar py-1 navbar-expand-lg flex justify-between items-center relative duration-300">
                  <a class="navbar-brand" href="index.html">
                    <img src="{{ asset('assets/images/user/logo-aplikasi.png') }}" alt="Logo" height="150px" width="150px">
                  </a>
      ...
      <div class="container">
        <div class="flex justify-between">
          <div class="w-full text-center">
            <h2 class="text-4xl font-bold leading-snug text-gray-700 mb-10 wow fadeInUp" data-wow-delay="1s">KITA PTN</h2>
      ...
      <div class="container">
        ...
        <div class="flex flex-wrap justify-center">
          ...
          <div class="max-w-sm sm:w-1/2 md:w-1/2 lg:w-1/3">
            <div class="team-item">
              <div class="team-img relative">
                <img class="img-fluid" src="{{ asset('assets/images/user/andara.jpeg') }}" alt="">
                <div
                  class="team-overlay">
                  <ul class="flex justify-center">
                    <li class="mx-1">
