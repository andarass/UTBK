        ...
        <form id="kt_account_profile_details_form" method="POST" enctype="multipart/form-data" action="{{ route('update.profile') }}" class="form">
            ...
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="username" class="form-control form-control-lg form-control-solid" placeholder="Username" value="{{ auth()->user()->username }}" />
                    </div>
                    <!--end::Col-->
                </div>
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="nomer_tlp" class="form-control form-control-lg form-control-solid" placeholder="Nomer Telepon" value="{{ auth()->user()->nomer_tlp }}" />
                    </div>
                    <!--end::Col-->
                </div>
                <div class="row mb-6">
