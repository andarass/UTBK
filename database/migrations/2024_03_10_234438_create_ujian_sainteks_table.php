...
return new class extends Migration
{
    ...
    {
        Schema::create('ujian_sainteks', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('konten_bacaan_id')->nullable()->constrained('konten_bacaan_sainteks');
    ...
    {
        Schema::dropIfExists('ujian_sainteks');
    }
};
