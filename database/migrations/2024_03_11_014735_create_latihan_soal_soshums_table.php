...
return new class extends Migration
{
    ...
    {
        Schema::create('latihan_soal_soshums', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('konten_bacaan_latihan_soal_id')->nullable()->constrained('konten_bacaan_latihan_soal_soshums');
    ...
    {
        Schema::dropIfExists('latihan_soal_soshums');
    }
};
